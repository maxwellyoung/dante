...
static const ModelRegistryEntry k_model_registry[] = {
    ...
    {"suitcase", "assets/suitcase.glb", MODEL_KIND_PROP, false, 3, true, MODEL_STATUS_DORMANT},
    {"telescope", "assets/telescope.glb", MODEL_KIND_PROP, false, 3, true, MODEL_STATUS_DORMANT},
