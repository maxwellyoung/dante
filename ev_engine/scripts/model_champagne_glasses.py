...
~80 tris. Lipstick is the single Godard red accent.
"""
import sys, os
...
kit = EVModelKit()
kit.begin("ChampagneGlasses", tri_budget=150)
...
kit.torus("TrayRim", (0, 0, 0.02), major_radius=0.25, minor_radius=0.008,
          material=BRASS, major_segments=12, minor_segments=4)
...
kit.sphere("Wine_Bowl", (0.12, -0.06, 0.11), radius=0.03,
           material=GLASS, segments=8, rings=6)
